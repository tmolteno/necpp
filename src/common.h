...
/* config.h is generated by CMake at configure time and placed on the include
   path. The old win32/nec2++/config.h branch is gone — CMake generates the
   header for all platforms (Linux, macOS, Windows, WASM). */
#include "config.h"
